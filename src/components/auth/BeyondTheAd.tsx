import { Binoculars, Calendar, Send, TrendingUp } from "lucide-react";

// Positions Punqle as an ongoing marketing partner, not a one-off
// generator — the 4 real capabilities beyond ad creation itself.
const ITEMS = [
  ...
  { icon: Send, label: "One-tap Publish", desc: "Straight to Facebook, Instagram, TikTok and YouTube." },
