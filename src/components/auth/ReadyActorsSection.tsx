...
// Grounded in a real actor photo, not an abstract icon, per founder
...
// face_1_curly_woman.png, copied to public/actors/face1.jpg) — not
...
// her. Founder's own pick for this specific spotlight — the hero
// panel above (FormatSwitcher.tsx) stays on face3, this section only.
const STEPS = [
  {
    n: "01",
    title: "Film once",
    ...
    <section className="relative left-1/2 z-10 w-screen -translate-x-1/2 bg-secondary px-6 py-20 sm:px-10">
      ...
      <div className="mx-auto mt-12 grid max-w-4xl grid-cols-1 items-center gap-10 sm:grid-cols-[280px_1fr]">
        <div className="relative aspect-[3/4] overflow-hidden rounded-[22px]" style={{ boxShadow: "var(--shadow-card)" }}>
          <img src="/actors/face1.jpg" alt="A real filmed Punqle actor" className="h-full w-full object-cover" />
          <span
